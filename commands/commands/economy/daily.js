    ...
    callback: async (message) => {
        ...
        try{
            if(lastDaily !== null && cooldown - (Date.now() - lastDaily) > 0){
                ...
                .setDescription(`<:emojino:796264735649300480> Sorry! You have already claimed your dailies. Please wait until ${finalTime} to do daily again!`)
                .setColor('ORANGE')
                ...
                const embed = new Discord.MessageEmbed()
                .setAuthor(`${message.author.tag}`, message.author.displayAvatarURL())
                .setDescription(`<:emojiyes:796264735833980968> Yay! You have claimed your dailies and you got $${amount}!\nYou can claim your dailies again in 24 hours!`)
                .setColor('ORANGE')
                .setFooter('Hope\'s Discord Cafe')
                .setTimestamp(new Date())
                return message.channel.send(embed)
