    ...
    callback: async(message, args) => {
        ...
        if(message.member.hasPermission('MANAGE_ROLES')){
            ...
            if(!user){
                ...
                .setDescription(`<:emojino:796264735649300480> Please mention someone to mute!`)
                .setColor('ORANGE')
            ...
            if(!mutedRole){
                ...
                if(!user.hasPermission('MANAGE_GUILD')){
                    ...
                    const embed = new MessageEmbed()
                    .setDescription(`<:emojiyes:796264735833980968> Successfully muted <@${user.id}>`)
                    .setColor("ORANGE")
                    .setFooter('Hope\'s Discord Cafe')
                    .setTimestamp()
                    message.channel.send(embed)
                    ...
                    const embed = new MessageEmbed()
                    .setDescription(`<:emojino:796264735649300480> That user is a mod/admin! I can't mute them!`)
                    .setColor('ORANGE')
                    .setFooter('Hope\'s Discord Cafe')
                    .setTimestamp()
                    message.channel.send(embed)
